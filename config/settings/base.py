...
APPS_DIR = ROOT_DIR.path("budgeting")
...
DATABASES = {"default": env.db("DATABASE_URL", default="sqlite:///sqlite.db")}
...
# https://docs.djangoproject.com/en/3.0/ref/contrib/staticfiles/#staticfiles-finders
STATICFILES_FINDERS = [
...
TEMPLATES = [
    {
        # https://docs.djangoproject.com/en/3.0/ref/settings/#std:setting-TEMPLATES-BACKEND
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        # https://docs.djangoproject.com/en/3.0/ref/settings/#template-dirs
...
# FIXTURES
# ------------------------------------------------------------------------------
# https://docs.djangoproject.com/en/3.0/ref/settings/#fixture-dirs
...
ADMINS = [("""Coen Mulders""", "coen.mulders@gmail.com")]
